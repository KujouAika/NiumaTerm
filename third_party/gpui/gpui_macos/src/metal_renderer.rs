...
impl MetalRenderer {
    ...
    fn draw_surfaces(
        ...
        for surface in surfaces {
            ...
            // `CVMetalTextureCache::create_texture_from_image` takes the generic
            // `CVImageBuffer` supertype; a `CVPixelBuffer` reaches it through the
            // retaining upcast rather than a plain reference coercion.
